...
const ConfirmDeleteComponent = () => {
  ...
  return (
    ...
    <Paper elevation = {3} style={paperStyle}>
        <h2 style={{color:'blue', textAlign:'center'}}>Are you sure you want to delete {flavour.toUpperCase()} Ice Cream?</h2>
        <Box component="form" sx={{'& > :not(style)': { m: 1},}} noValidate autoComplete="off">
            ...
            <TableContainer component={Paper}>
                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                    ...
                    <Button variant='contained' color='error' style={{float:'right'}} onClick={() => deleteIceCream(flavourCode)}><b>Delete</b></Button>
